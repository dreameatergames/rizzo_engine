...
void R_InitLights(void) {
  dlight_vert[0] = (glvert_fast_t){.flags = 0, .vert = {0, 0, 0}, .texture = {0, 0}, .color = {(uint8_t)(0.0f * 255), (uint8_t)(0.1f * 255), (uint8_t)(0.2f * 255), (uint8_t)(1.0f * 255)}, .pad0 = {0}};
  for (int i = 1; i < 18; i++) {
    dlight_vert[i] = (glvert_fast_t){.flags = 0, .vert = {0, 0, 0}, .texture = {0, 0}, .color = {0, 0, 0, 0}, .pad0 = {0}};
  }
}
