...
void M_Options_Draw (void)
{
	...
	M_Print (16, 88, "          Invert Mouse");
	M_DrawCheckbox (220, 88, m_pitch.value < 0);

	M_Print (16, 96, "            Lookspring");
	M_DrawCheckbox (220, 96, lookspring.value);

	M_Print (16, 104, "Anti-Epilepsy Lighting");
	M_DrawCheckbox (220, 104, r_dynamic.value);
	
	M_Print (16, 112, "       Scale Menu Size"); 
	r = (scr_menuscale.value/2);
...
void M_Developer_Draw (void)
{
	...
	y += text_size; M_Print (16, y, "             developer"); M_DrawCheckbox (220, y, developer.value);
	y += text_size; M_Print (16, y, "          chase_active"); M_DrawCheckbox (220, y, registered.value);
	...
	y += text_size; M_Print (16, y, "              map e2m1");
